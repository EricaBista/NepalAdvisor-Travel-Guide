...
class DescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post :create, description: { Content: @description.Content, Order: @description.Order, Title: @description.Title, item_id: @description.item_id }
    end
  ...
  test "should update description" do
    patch :update, id: @description, description: { Content: @description.Content, Order: @description.Order, Title: @description.Title, item_id: @description.item_id }
    assert_redirected_to description_path(assigns(:description))
  end
