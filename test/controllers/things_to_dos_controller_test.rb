...
class ThingsToDosControllerTest < ActionController::TestCase
  ...
  test "should create things_to_do" do
    assert_difference('ThingsToDo.count') do
      post :create, things_to_do: { Content: @things_to_do.Content, Name: @things_to_do.Name, Title: @things_to_do.Title }
    end
  ...
  test "should update things_to_do" do
    patch :update, id: @things_to_do, things_to_do: { Content: @things_to_do.Content, Name: @things_to_do.Name, Title: @things_to_do.Title }
    assert_redirected_to things_to_do_path(assigns(:things_to_do))
  end
